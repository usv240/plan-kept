...
app.include_router(build_router(workspace_store,wake_scheduler,ALLOW_GLOBAL_RESET));app.include_router(build_pilot_router(workspace_store));app.include_router(build_hardening_router(workspace_store,wake_scheduler,clock))
